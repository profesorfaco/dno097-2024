# DESARROLLO WEB Y DISEÑO VISUAL DE INFORMACION
...
Partiendo desde el dominio de HTML, CSS y JavaScript, en este curso el estudiantado vinculará gráficos vectoriales escalables con formatos ligeros de intercambio de datos, para desarrollar, de manera autónoma, tableros de información (dashboards) e infografías digitales, interactivas y dinámicas. Para ello, se realizarán clases invertidas, simulaciones y aprendizaje basado en problemas. Los aprendizajes serán evaluados por medio de actividades de aplicación en cada clase.
